...
public class ChooseUserHeadDialogUtil {
    ...
    public static void showDialog(final Context context, final String username, final long timeStamp) {
        ...
        tv_select_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    //步骤二：Android 7.0及以上获取文件 Uri
                    mUri = FileProvider.getUriForFile(context, "com.domineer.triplebro.bookkeeping", file);
                } else {
                    //步骤三：获取文件Uri
                    mUri = Uri.fromFile(file);
                }
